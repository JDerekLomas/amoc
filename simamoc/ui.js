...
var viewBtnSelector = '#btn-psi,#btn-vort,#btn-speed,#btn-temp,#btn-deeptemp,#btn-deepflow,#btn-sal,#btn-density,#btn-depth,#btn-clouds,#btn-airtemp';
['psi','vort','speed','temp','deeptemp','deepflow','sal','density','depth','clouds','airtemp'].forEach(function(v) {
